<div class="footer-area">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3">
          <h4 class="footer-heading">Funda Restaurant</h4>
        ...
        <div class="col-md-3">
          ...
          <div class="footer-link">
            <div>
              <a href="#"> <i class="fa fa-map-marker"></i> Street name 1, City</a>
            </div>
            <div>
              <a href="#"> <i class="fa fa-phone"></i> +1 888 222 6666</a>
            </div>
            <div>
              <a href="#"> <i class="fa fa-envelope"></i> email@companyname.com</a>
            </div>
            <div>
              <a href="#"> <i class="fa fa-envelope"></i> email@companyname.com</a>
            </div>
        ...
        <div class="col-md-12 text-center">
          ...
          <p class="text-white f-12">
            &copy; Copyright at Funda Restaurant. All Rights Reserved.
          </p>
        </div>
      </div>
    </div>
